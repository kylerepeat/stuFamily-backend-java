...
-- ============================================================================
-- Production baseline data (safe, idempotent, no demo/postman records)
-- ============================================================================
SET client_encoding = 'UTF8';
SET standard_conforming_strings = on;
...
-- Visibility rules required by product display permission controls.
INSERT INTO visibility_rule (
    ...
    ('LOGIN_REQUIRED', FALSE, TRUE, FALSE, FALSE, FALSE),
    ('FAMILY_REQUIRED', FALSE, TRUE, TRUE, TRUE, FALSE),
    ('VALUE_ADDED_REQUIRED', FALSE, TRUE, TRUE, TRUE, TRUE)
...
INSERT INTO service_category (
    ...
    ('FAMILY_CARD', 'Family Card', 'Family card products', 10, TRUE),
    ('VALUE_ADDED', 'Value-added Service', 'Pickup, cleaning and other services', 20, TRUE)
...
-- Ensure one active site profile exists for home page rendering.
...
SELECT
    'Stu Family Service Center',
    'Welcome to Stu Family',
    'Please update this site profile in admin system after deployment.',
    '',
    '',
    '',
    '',
    ...
    TRUE
WHERE NOT EXISTS (
    SELECT 1 FROM site_profile WHERE active = TRUE
);
